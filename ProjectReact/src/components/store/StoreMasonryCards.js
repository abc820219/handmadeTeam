    ...
    <Root>
      {storeDataLoad.map((item, index) => (
        <Brick className="storeMasonryCard">
          <img
            className="storeSpacePhoto"
            src={`/image/store/${item.store_space_photo}`}
          />
          <div className="storeCardTop">
            ...
            <div className="showConditionGroup">
              {item.store_partner == 1 && (
                <div className="showConditionPeople">
                  <MdPeopleOutline />
                </div>
              )}
              {item.store_child == 1 && (
                <div className="showConditionChild">
                  <MdChildCare />
                </div>
              )}
            </div>
          ...
          <div className="storeCardDown">
            <div className="storeCardDownMain">
              <img
                className="storeLogoPhoto"
                src={`/image/store/${item.store_logo}`}
              />
            ...
            <div className="storeEnterButton">
              ...
              <a
                className="storeEnterStore"
                href={`/handmade/store/${item.store_sid}/course`}
              >
                <FaStore /> GO TO Store
              </a>
            </div>
