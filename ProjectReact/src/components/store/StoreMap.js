...
const SvgComponent = props => (
  <svg viewBox="0 0 566.9 850.4" {...props}>
    <path
      className="prefix__st0  prefix__storeCountry nantouMap"
      d="M188.1 414.2v-85.6l50.3-28.8L360 269.6v30.9l-29 119.1-46.4 44.3z"
    />
    <path
      className="prefix__st1 prefix__storeCountry hualienMap"
    ...
    />
    <path
      className="prefix__st2 prefix__storeCountry taichungMap"
    ...
    />
    <path
      className="prefix__st1 prefix__storeCountry changhuaMap"
      d="M94 363.4l22.8-47.4 18.1-1.2 18-33.3 40.1 39.7-9.2 5.2v47.8z"
    />
    <path
      className="prefix__st2 prefix__storeCountry yunlinMap"
      d="M73.7 441.3l-6.3-25.1 25-49.1 91.4 11v38.4l23.9 12.3-43.6-4-8.1-11.1-28.4 1.4-48.2 30.8z"
    />
    <path
      className="prefix__st1 prefix__storeCountry chiayiMap"
    ...
    />
    <path
      className="prefix__st2 prefix__storeCountry kaohsiungMap"
    ...
    />
    <path
      className="prefix__st0 prefix__storeCountry tainanMap"
    ...
    />
    <path
      className="prefix__st2 prefix__storeCountry keelungMap"
      d="M437.6 45.2l22.9-5.5 32.9 8.6-47 19.2z"
    />
    <path
      className="prefix__st3 prefix__storeCountry yilanMap"
      d="M388.5 235.9l-3.4-6.8-13.7 4.7-10.5-16.9 22-32 10.6-24.5 33.6-12.8 54.5-55 35.9-8.7-44.1 50.1 20.5 45.3-28.5 67.5z"
    />
    <path
      className="prefix__st2 prefix__storeCountry taoyuanMap"
