...
const SvgComponent = props => {
  ...
  return (
    <svg className="taiwanMap" onMouseLeave={() => setAreaNowCatch("全島")} viewBox="0 0 566.9 850.4" {...props} onClick={()=>{storeData()}}>
      <path
      ...
      <path
        onMouseEnter={(event) => areaNow(event)}
        mapValue="19"
        className={ locateClick ===19 ? "prefix__st1 prefix__storeCountry pingtungMap fillBackGround" : "prefix__st1 prefix__storeCountry pingtungMap"}
        onClick={()=>setLocateClick(19)}
        d="M218.4 823.4l-8.6 11.4L185 732.7l-47.5-33.8 14.1-86.5 94 2-40 64.6 27.4 85.3 18.4-2.9-6.2 78.7z"
      />
      <path
        onMouseEnter={(event) => areaNow(event)}
        mapValue="8"
        className={ locateClick ===8 ? "prefix__st1 prefix__storeCountry miaoliMap fillBackGround" : "prefix__st1 prefix__storeCountry miaoliMap"}
        onClick={()=>setLocateClick(8)}
        d="M214.6 248.4l-22.5-33.9 52.6-64.4 25.8 2.4 31.1 43.8 39.3 24.9-52.4 29.5-10.2-8.3-21.4-.8-2.7 9.4z"
      />
      <path
        onMouseEnter={(event) => areaNow(event)}
        className={ locateClick ===5 ? "prefix__st2 prefix__storeCountry hsinchu_1Map fillBackGround" : "prefix__st2 prefix__storeCountry hsinchu_1Map"}
      ...
      <path
        onMouseEnter={(event) => areaNow(event)}
        className={ locateClick ===6 ? "prefix__st0 prefix__storeCountry hsinchu_2Map fillBackGround" : "prefix__st0 prefix__storeCountry hsinchu_2Map"}
        onClick={()=>setLocateClick(6)}
        mapValue="6"
      ...
      <path
        onMouseEnter={(event) => areaNow(event)}
        mapValue="2"
        className={ locateClick ===2 ? "prefix__st1 prefix__storeCountry taipeiMap fillBackGround" : "prefix__st1 prefix__storeCountry taipeiMap"}
      ...
      <path
        onMouseEnter={(event) => areaNow(event)}
        mapValue="3"
        className={ locateClick ===3 ? "prefix__st0 prefix__storeCountry newTaipeiMap fillBackGround" : "prefix__st0 prefix__storeCountry newTaipeiMap"}
      ...
      <path
        onMouseEnter={(event) => areaNow(event)}
        mapValue="1"
        className={ locateClick ===1 ? "prefix__st2 prefix__storeCountry keelungMap fillBackGround" : "prefix__st2 prefix__storeCountry keelungMap"}
        onClick={()=>setLocateClick(1)}
        d="M437.6 45.2l22.9-5.5 32.9 8.6-47 19.2z"
      />
      <path
        onMouseEnter={(event) => areaNow(event)}
        mapValue="7"
        className={ locateClick ===7 ? "prefix__st3 prefix__storeCountry yilanMap fillBackGround" : "prefix__st3 prefix__storeCountry yilanMap"}
        onClick={()=>setLocateClick(7)}
        d="M388.5 235.9l-3.4-6.8-13.7 4.7-10.5-16.9 22-32 10.6-24.5 33.6-12.8 54.5-55 35.9-8.7-44.1 50.1 20.5 45.3-28.5 67.5z"
      />
      <path
        onMouseEnter={(event) => areaNow(event)}
        mapValue="4"
        className={ locateClick ===4 ? "prefix__st2 prefix__storeCountry taoyuanMap fillBackGround" : "prefix__st2 prefix__storeCountry taoyuanMap"}
